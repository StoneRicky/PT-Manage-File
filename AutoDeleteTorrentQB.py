...
class Torrent:
    ...
    def __init__(self,name,size,lastActiveTime,uploadedSize,addTime,upSpeed,tag):
        ...
        self.uploadedSize = Fore.BLUE + str(round(uploadedSize/1024/1024/1024,3)) + Fore.RESET + "G"
...
for deleteSize in deleteSizes:
    for tr in fullTrs:
        if deleteSize == tr['size']:
            ...
            # print输出
            p1 = Torrent(tr['name'],tr['size'],t-tr['last_activity'],tr['uploaded'],tr['added_on'],tr['upspeed'],tr['tags'])
            p1.getPrint()
